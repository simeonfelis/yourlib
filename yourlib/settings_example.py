...
MEDIA_ROOT = os.path.join(BASE_SERVER, 'media')
...
STATIC_ROOT = os.path.join(BASE_SERVER, 'static')
...
SECRET_KEY = '[ORC)!W3r3H`Pj`~R4X$Hj)NYW+*<n*,~=XKJ&``C1-PrxD<A<'
...
ROOT_URLCONF = 'yourlib.urls'
LOGIN_URL = 'accounts/login/'
APPEND_SLASH = True

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'yourlib.wsgi.application'
