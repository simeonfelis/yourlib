...
PROJ="/home/http/webapps/yourlib"

CELERYD_USER="http"
CELERYD_GROUP="http"
CELERYD_CHDIR=$PROJ
ENV_PYTHON=/home/http/envs/yourlib/bin/python

CELERYCTL="$ENV_PYTHON $PROJ/manage.py celeryctl"
CELERYD_MULTI="$ENV_PYTHON $PROJ/manage.py celeryd_multi"

CELERYD_PID_FILE=${CELERYD_PID_FILE:-${CELERYD_PIDFILE:-$DEFAULT_PID_FILE}}
CELERYD_LOG_FILE=${CELERYD_LOG_FILE:-${CELERYD_LOGFILE:-$DEFAULT_LOG_FILE}}
CELERYD_LOG_LEVEL=${CELERYD_LOG_LEVEL:-${CELERYD_LOGLEVEL:-$DEFAULT_LOG_LEVEL}}
CELERYD_MULTI=${CELERYD_MULTI:-"celeryd_multi"}
